...
import com.home.app.ws.fullstackappws.shared.UserDto;
import com.home.app.ws.fullstackappws.ui.model.request.UserLoginRequestModel;
	    ...
	    protected void successfulAuthentication(HttpServletRequest req,
		 ...
		 String userName = ((UserPrincipal) auth.getPrincipal()).getUsername(); 
	        ...
	        String token = Jwts.builder() //JWT- JSON Web Token
	                ...
	                .compact();
	        UserService userSrvice = (UserService) SpringApplicationContext.getBean("userServiceImpl");
	       UserDto userDto =  userSrvice.getuser(userName);
